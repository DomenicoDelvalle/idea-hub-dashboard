...
export const ProjectMgmtIcon: React.FC = () => (
  <IconWrapper>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-6 w-6"
...
export const SparklesIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M5 3v4M3 5h4M6.343 6.343l-2.828 2.828M17.657 17.657l2.828 2.828m-4.243-4.243l1.414-1.414M12 21v-4M21 12h-4M12 3v4M3 12h4m-4 4l2.828 2.828M19 5l-2.828 2.828"
    />
  </svg>
);
export const LightningBoltIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"

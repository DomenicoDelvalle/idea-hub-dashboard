...
const IconWrapper: React.FC<{ children: React.ReactNode }> = ({ children }) => (
    <div className="w-7 h-7 flex items-center justify-center text-slate-400">{children}</div>
);
...
export const BlueprintIcon: React.FC = () => (
    <IconWrapper>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5M3.75 6h16.5M3.75 18h16.5" transform="rotate(45 12 12)" />
        </svg>
    </IconWrapper>
);
...
export const ProjectMgmtIcon: React.FC = () => (
    <IconWrapper>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V7a2 2 0 012-2h5l4 4v10a2 2 0 01-2 2z" />
        </svg>
    </IconWrapper>
);
...
export const SparklesIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6.343 6.343l-2.828 2.828M17.657 17.657l2.828 2.828m-4.243-4.243l1.414-1.414M12 21v-4M21 12h-4M12 3v4M3 12h4m-4 4l2.828 2.828M19 5l-2.828 2.828" />
    </svg>
);
